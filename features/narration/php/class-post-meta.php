...
/**
 * Owns the three meta keys that record a post's narration.
 *
...
class Post_Voice_Post_Meta {
	 ...
	 * @param string $meta_key Meta key being authorised (unused; all three share one rule).
	...
	/**
	 * Register the three meta keys on the `post` post type.
	 */
